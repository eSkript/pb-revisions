...
class Pb_Revisions {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pb_Revisions_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'PB_REVISIONS_VERSION' ) ) {
			$this->version = PB_REVISIONS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'pb-revisions';
	 ...
	 *
	 * - Pb_Revisions_Loader. Orchestrates the hooks of the plugin.
	 * - Pb_Revisions_i18n. Defines internationalization functionality.
	 * - Pb_Revisions_Admin. Defines all hooks for the admin area.
	 * - Pb_Revisions_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pb-revisions-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pb-revisions-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pb-revisions-admin.php';
		...
		$this->loader = new Pb_Revisions_Loader();
	 ...
	 *
	 * Uses the Pb_Revisions_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Pb_Revisions_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Pb_Revisions_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Pb_Revisions_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Pb_Revisions_Loader    Orchestrates the hooks of the plugin.
	 */
