...
<button type="submit" class="button button-hero button-primary generate right" name="pb_revisions_action" value="publish_version_one"  onclick="if ( !confirm('<?php esc_attr_e( 'Are you sure you want to publish this version? There is no way back!', 'pb-revisions' ); ?>' ) ) { return false }"><?php _e('Publish Version 1.0.0', 'pb-revisions');?></button>
</form>
<div class="clear"></div>
</div>
</div>