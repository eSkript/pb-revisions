	...
	<div>
		<div>
			...
			<form action="<?php echo esc_url($form_url) ?>" method="POST">
				...
				<button type="submit" class="button button-hero button-primary generate" name="pb_revisions_action" value="create_version">Create <?php echo esc_html($data['major_number']); ?></button>
			</form>
		</div>
		<div>
			...
			<form action="<?php echo esc_url($form_url) ?>" method="POST">
				...
				<button type="submit" class="button button-hero button-primary generate" name="pb_revisions_action" value="create_version">Create <?php echo esc_html($data['minor_number']); ?></button>
			</form>
		</div>
		<div>
			...
			<form action="<?php echo esc_url($form_url) ?>" method="POST">
				...
				<button type="submit" class="button button-hero button-primary generate" name="pb_revisions_action" value="create_version">Create <?php echo esc_html($data['patch_number']); ?></button>
			</form>
		</div>
	</div>
</div>