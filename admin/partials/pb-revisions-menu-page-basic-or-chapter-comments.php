...
<div class="wrap">
	<div class="pb_revisions_dialog">
		...
		?>
			<a class="button button-hero button-primary generate pb_revisions_button_list__button" href=<?php echo esc_url($next_chapter_url);?>><?php _e('Chapter Specific Comments', 'pb-revisions');?></a>
		<?php } ?>
		<a class="button button-hero button-primary generate pb_revisions_button_list__button" href=<?php echo esc_url($summary_url);?>><?php _e('Just One Comment For Everything', 'pb-revisions');?></a>
		</div>
	</div>
</div>