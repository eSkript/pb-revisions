(function ($) {
    $( document ).ready(function() {
        if(PBRevisionsButton.is_on){
            $(".a11y-toolbar ul").append('<li><a href="'+PBRevisionsButton.hide_url+'" role="button" title="'+PBRevisionsButton._deactivatePreview+'"><span class="dashicons pbricons-revision"></span></a></li>');
